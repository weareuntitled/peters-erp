...
This implementation provides the core business logic for Phase 3:
...
The implementation follows the existing code patterns and maintains data integrity through proper transactions and validation.