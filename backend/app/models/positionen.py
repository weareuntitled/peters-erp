...
class PositionBase(SQLModel):
    ...
    formel_wert1: Optional[float] = Field(default=None, sa_column=Column(Float))
    formel_wert2: Optional[float] = Field(default=None, sa_column=Column(Float))
    formel_wert3: Optional[float] = Field(default=None, sa_column=Column(Float))
    formel_ergebnis: Optional[float] = Field(default=None, sa_column=Column(Float))
